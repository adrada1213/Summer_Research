...
if __name__ == "__main__":
    ...
    ptr_filename = "8S_ZZ_TT_8T_Bio_match.img_imageptr"
    ...
    cine_dicom_paths, tagged_dicom_paths, cine_images, tagged_images, cine_px_spaces, tagged_px_spaces, cine_img_pos, tagged_img_pos, cine_img_orient, tagged_img_orient = prepare_dicom_images(filepaths, ptr_content, slices, view)